 ...
 * on 2016.09.11:49
 */
public class PhotosFragment extends BaseFragment<PhotosListPresenter,PhotosListModel> implements PhotoListContract.View ,OnRefreshListener,OnLoadMoreListener{
//    @Bind(R.id.ntb)
//    NormalTitleBar ntb;
    @Bind(R.id.irc)
    IRecyclerView irc;
