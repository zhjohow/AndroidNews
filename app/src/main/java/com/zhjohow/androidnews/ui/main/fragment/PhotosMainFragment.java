package com.zhjohow.androidnews.ui.main.fragment;
...
import com.zhjohow.androidnews.ui.news.activity.PhotosDetailActivity;
import com.zhjohow.androidnews.ui.news.contract.PhotoListContract;
import com.zhjohow.androidnews.ui.news.model.PhotosListModel;
import com.zhjohow.androidnews.ui.news.presenter.PhotosListPresenter;
import com.zhjohow.common.base.BaseFragment;
import com.zhjohow.common.commonwidget.LoadingTip;
import com.zhjohow.common.commonwidget.NormalTitleBar;
        ...
        adapter=new CommonRecycleViewAdapter<PhotoGirl>(getContext(),R.layout.item_photo) {
            ...
            public void convert(ViewHolderHelper helper,final PhotoGirl photoGirl) {
                ...
                Glide.with(mContext).load(photoGirl.getUrl())
                        ...
                        .placeholder(com.zhjohow.common.R.drawable.ic_image_loading)
                        .error(com.zhjohow.common.R.drawable.ic_empty_picture)
